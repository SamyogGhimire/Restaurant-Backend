...
func GetOrderItemsByOrder() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured while listing the oreder items by order id"})
			return
		}
		c.JSON(http.StatusOK, allOrderItems)
...
func ItemsByOrder(id string) (orderItems []primitive.M, err error) {
	...
	lookupStage := bson.D{{Key: "$lookup", Value: bson.D{{Key: "from", Value: "food"}, {Key: "localField", Value: "food_id"}, {Key: "foreignField", Value: "food_id"}, {Key: "as", Value: "Value:food"}}}}
